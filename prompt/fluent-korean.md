<!--
fluent-korean (output-styles/fluent-korean-not-coding.md)
출처: https://github.com/snflkd/fluent-korean  라이선스: MIT
Claude Code output-style 을 pi 의 --append-system-prompt 로 쓰기 위해
YAML 프런트매터만 걷어내고 본문을 그대로 가져왔다.
-->
