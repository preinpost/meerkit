...
COPY run_review.py post_review.py forge.py diff_limits.py meridian_runner.py /opt/meerkit/
COPY prompt/ /opt/meerkit/prompt/
RUN chmod +x /opt/meerkit/run_review.py /opt/meerkit/post_review.py \
 && ln -s /opt/meerkit/run_review.py /opt/meerkit/run-review.py
